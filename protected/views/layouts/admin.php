                    ...
                    'items' => array(
                        ...
                        array('label' => "Processing", 'url' => array('#'), 'visible' => true,
                            ...
                            'items' => array(
                                ...
                                array('label' => "Create Product List", 'url' => array('/ProductList/create'),'visible'=>User::checkTask('createproductlist')),
                                array('label' => "Manage Product List", 'url' => array('/ProductList/admin'),'visible'=>User::checkTask('manageproductlist')),
